        ...
        <div className="topBar">
            <div className="topBarLeft">
                <div className="logo">
                    ...
                    <Link to="/home" className="topBarLogo">EtioBook</Link>
                </div>
            </div>
            ...
            <div className="topBarRight">
                <div className="topBarRightMEssage">
                    <div className="message">
                        <BiMessageDetail className="topBarIcon" onClick={() => setIsShowMessage(true)} />
                ...
                <Link to="/profile"><img src="/assets/people/1.jpg" alt="" className="profilePicture" /></Link>
            </div>
        </div>);
}
